...
public class teleopTest extends LinearOpMode
{
    ...
    boolean driveDpadD;
    boolean driveDpadR;
    boolean isDriveDpadUPressed = false;
    boolean isDriveDpadDPressed = false;
    ...
    int velocityShootingIncrement = 0;
    double velocityShootingTest = 1200;
    ...
    public void getDistFromGoal()
    {
        ...
        //velocityShooting = (distanceToGoal - 100) * ((robot.velocityShootingMax - robot.velocityShootingMin) / 200) + robot.velocityShootingMin;
        driveDpadU = gamepad1.dpad_up;
        driveDpadD = gamepad1.dpad_down;
        if(driveDpadU && !isDriveDpadUPressed)
        {
            velocityShootingIncrement++;
            isDriveDpadUPressed = true;
        }
        else
        {
            isDriveDpadUPressed = false;
        }
        if(driveDpadD && !isDriveDpadDPressed)
        {
            velocityShootingIncrement--;
            isDriveDpadDPressed = true;
        }
        else
        {
            isDriveDpadDPressed = false;
        }

        velocityShooting = velocityShootingTest + (velocityShootingIncrement * 10);
    ...
    public void showTelemetry()
    {
        ...
        telemetry.addData("Shooting Velocity Test", velocityShooting);
    ...
    public void initialize2()
    {
        ...
        robot.changePipeline(3);//3 IS TESTING PIPELINE
        waitForStart();
