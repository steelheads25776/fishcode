...
@Autonomous
public class a_4bucket extends OpMode
{
    ...
    public void autonomous()
    {
        ...
        else if (step.equalsIgnoreCase("start started"))
        {
            ...
            {
                step = "move to score preload";
            }
        }
        else if(step.equalsIgnoreCase("move to score preload"))
        {
        ...
        else if(step.equalsIgnoreCase("raise arm to score preload"))
        {
            if(positionXTarget < -9999)
            {
                ...
                armDirection = "up";
                slideTarget = 2200;
                step = "raise arm to score preload arm";
            }
        }
        else if(step.equalsIgnoreCase("raise arm to score preload arm"))
        {
            if(slideTarget < 0)
            {
                //servoClawExtend.setPosition(armExtendedPosition);
        ...
        else if(step.equalsIgnoreCase("lower from preload"))
        {
            if (timer.milliseconds() > 300)
            {
                ...
                slideTarget = 0;
                timer.reset();
                step = "reset encoders preload";
            }
        }
        else if(step.equalsIgnoreCase("reset encoders preload"))
        {
        ...
        {
            if (timer.milliseconds() > 400 && positionYTarget < -9999)//timer 300
            {
                servoClawGrabber.setPosition(clawClosedPosition);
