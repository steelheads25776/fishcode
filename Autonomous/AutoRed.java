    ...
    */
    ...
    public void Autonomous()
    {
        ...
        else if(step.equalsIgnoreCase("move shoot pre 2") && !navEngaged)
        {
            ...
            navOrientationTarget = 38;//40 , 45, 42
            navOnlyRotate = false;
            navPrecise = true;
            navEngaged = true;
            step = "shoot pre";
        ...
        else if(step.equalsIgnoreCase("move shoot a1") && !navEngaged)
        {
            ...
            navOrientationTarget = 38;//45 41 42 40
            navOnlyRotate = false;
        ...
        else if(step.equalsIgnoreCase("move collect a2 p1") && !navEngaged)
        {
            timer.reset();
            intakeMotor.setPower(1.0);
            navSpeedOverride = -1.0;
        ...
        else if(step.equalsIgnoreCase("move shoot a2 p4") && !navEngaged)
        {
            ...
            */
            navOrientationTarget = 38;//315, 55
            navOnlyRotate = false;
            navPrecise = true;
            navEngaged = true;
            timer.reset();
